...
class INNExperiment(object):
    ...
    def att_amb_key(self):
        ...
        for pu, pp, ps in zip(self.passport_user, self.passport_owner, self.genuine_user_ID):
            ...
            # with open('/home/ruohan/MOA_copy/log/attacks/att_amb_key_forgeID_psnr_att_key_s_dict.json', 'w') as json_file:
            #     json.dump(self.psnr_att_key_s_dict, json_file)
            # with open('/home/ruohan/MOA_copy/log/attacks/att_amb_key_forgeID_psnr_att_key_k_dict.json', 'w') as json_file:
            #     json.dump(self.psnr_att_key_k_dict, json_file)
            with open('/home/ruohan/MOA_copy/log/attacks/att_amb_key_genuineID_psnr_att_key_s_dict.json', 'w') as json_file:
                json.dump(self.psnr_att_key_s_dict, json_file)
            with open('/home/ruohan/MOA_copy/log/attacks/att_amb_key_genuineID_psnr_att_key_k_dict.json', 'w') as json_file:
                json.dump(self.psnr_att_key_k_dict, json_file)
...
def main():
    ...
    parser.add_argument('--val-path', default='/home/ruohan/dataset/COCO2017/test2017', help=' token path')
    parser.add_argument('--fake-secret-path', default='/home/ruohan/dataset/COCO2017/test2017', help=' token path')
    #parser.add_argument('--fake-key-path', default='/home/ruohan/dataset/COCO2017/test2017', help=' token path')
